...
## 화요일
- 학습내용: 알고리즘 1문제, cs 디자인 패턴, swift커리어 계획
- 느낀점: ios 개발자로서 계획을 짜봤다. 당장 취업이 급해서 이런회사 저런회사 보여서 아무데나 지원하고 있긴한데, 결국 내 커리어를 짜는 계획이 중요한거 같다. 회사는 그냥 지나가는걸로 생각하고 커리어 전반계획을 알아보고 다부지게 설계해야겠다.
